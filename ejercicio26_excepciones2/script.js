...
//   }
  ...
  if (!paisesBuscadoMayusculas.includes(paisesBuscadoMayusculas)){
    // throw new Error(`El país ${pais} no está en la lista de países`)
    ErrorViaje.addError(`El país ${pais} no está en la lista de países`)
  }
...
try {
    // const resultado = organizarViaje('Francia', 5, 7);
    // console.log(organizarViaje('Francia', 5, 7));
    // const resultado = organizarViaje('Portugal', 1, 6);
    const resultado = organizarViaje('xxxxx', 1, 6);
